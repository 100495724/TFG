...
\begin{description}
	...
	\item[API] \textit{Application Programming Interface}. Interfaz mediante la
	que se accede a un modelo alojado por un proveedor externo, sin acceso a sus
	parámetros.
...
\begin{description}
	...
	\item[\textit{Arbitrariedad}] Propiedad de un sistema cuyas decisiones no son
	reproducibles entre ejecuciones equivalentes. Se distingue del sesgo
	direccional en que no implica un desplazamiento sostenido a favor o en contra
	de ningún grupo, y puede coexistir con métricas agregadas favorables.
	...
	\item[\textit{Fairness}] Criterio normativo sobre qué propiedades de una
	asignación deben permanecer invariantes entre individuos o grupos. No existe
	una formulación única; este trabajo adopta la perspectiva contrafactual.
	...
	obtenida de la condición placebo.
	...
	\item[\textit{Prompt}] Texto de entrada que recibe un modelo de lenguaje. En
	este diseño incluye el rol del agente, la información de la cesta, el formato
	de salida y, en la campaña de mitigación, la instrucción de neutralización.
