...
A ello se suma el carácter estocástico de la generación, es decir, dos ejecuciones de una misma configuración pueden producir decisiones distintas sin que haya cambiado nada en la entrada. Una evaluación basada solo en resultados medios puede pasar por alto que una condición determinada vuelve al sistema más variable, sobre todo cuando las diferencias positivas y negativas se cancelan al promediarse. La literatura sobre arbitrariedad y no determinismo ha insistido en caracterizar esa variabilidad junto a las métricas agregadas habituales~\cite{cooper2024arbitrariness,song2025good}, y la advertencia resulta especialmente pertinente en sistemas donde las diferencias iniciales pueden además interactuar con la comunicación posterior.

El ámbito financiero ofrece un escenario apropiado para estudiar estas cuestiones. Los modelos de lenguaje se emplean ya de forma experimental para analizar noticias, seleccionar activos y emitir recomendaciones de inversión, y varios trabajos han detectado diferencias demográficas y geográficas en dichas decisiones~\cite{winder2025biased,wang2026invests}. La asignación de un presupuesto fijo entre empresas añade dos ventajas para la medida. La primera, que las métricas financieras permiten construir contrafactuales exactos, en los que dos empresas comparten cifras idénticas y difieren solo en el atributo bajo estudio. Y la segunda es que el resultado se expresa en euros, de modo que cualquier diferencia de trato queda cuantificada en la misma unidad en la que se manifestaría un despliegue real.

Sobre ese escenario, la pregunta que se plantea es si un comité formado por varios agentes podría asignar, en una decisión financiera, menos capital a empresas teniendo en cuenta factores externos a los fundamentos financieros, como el género del CEO o la ubicación geográfica de la sede. Esta formulación presupone que la discriminación adopta la forma de un desplazamiento sostenido de la media de capital asignado. Este trabajo examina esa posibilidad, pero también otra distinta, la de que el atributo no incline la decisión en una dirección concreta, sino que la desestabilice de manera que una misma empresa reciba asignaciones muy dispares según la ejecución. Un sistema con ese comportamiento podría superar una auditoría basada únicamente en diferencias medias, es por ello que este trabajo no solo se centra en la dirección del efecto y estudia también la estabilidad de las decisiones.

La Figura~\ref{fig:esquema_experimento} resume el diseño empleado para
aislar el efecto de los atributos estudiados y distinguirlo de la
variabilidad propia del sistema.
...
\begin{figure}[htbp]
	...
	\caption{Esquema del diseño experimental. Cada cesta base da lugar a tres
