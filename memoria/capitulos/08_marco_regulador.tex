...
El desarrollo, el análisis y la redacción se realizaron sobre un equipo
portátil personal. Considerando un coste de adquisición de 870~\euro, una vida
útil de cinco años y un periodo de dedicación de siete meses, la amortización
imputable al proyecto asciende a 101,50~\euro.
...
\begin{table}[htbp]
	...
	\begin{tabular}{p{6.5cm} r}
		...
		Personal & 7.500,00 \\
		Cómputo & 78,60 \\
		Amortización de equipo & 101,50 \\
		\hline
		Subtotal de costes directos & 7.680,10 \\
		Costes indirectos (15\,\%) & 1.152,02 \\
		\hline
		\textbf{Total} & \textbf{8.832,12} \\
		\hline
	\end{tabular}
\end{table}
...
El coste de aplicar el procedimiento resulta modesto. La campaña completa de esta memoria, con seis composiciones, tres niveles de instrucción, dos atributos y tres repeticiones, consumió 78,60~\euro{} de cómputo según el desglose de la Sección~\ref{sec:presupuesto}. Una auditoría dirigida a una única configuración antes de su despliegue costaría una fracción de esa cifra, muy por debajo del esfuerzo de ingeniería necesario para integrarla. La barrera de adopción no es económica, sino de conocimiento del procedimiento, que es precisamente lo que este trabajo aporta. Por la misma razón, la huella ambiental asociada es reducida. Las 292,8 horas de GPU consumidas equivalen a un consumo eléctrico marginal frente al de entrenar o ajustar cualquiera de los modelos evaluados.
